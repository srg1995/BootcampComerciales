...
/*
 *  Establece el texto de enlace emergente y el atributo target="_blank"
 *  en enlaces con la clase 'ventana-nueva' o 'btn-ventana-nueva'
 */
function linksVentanaNueva() {
    var selector = 'a.ventana-nueva, a.ventanaNueva, a.btn-ventana-nueva';
    $(selector).attr('target', '_blank');

    if ($(document).find('html').attr('lang') === 'es') {
        $(selector).attr('title', 'Enlace externo, se abre en ventana nueva.');
    } else {
        $(selector).attr('title', 'External link, opens in new window.');
    }
}
...
/*
 *  Se a?ade la funcion addLoadEvent para los contenidos exitentes
 */
...
/*
 *  Prepara el enlace a los contenidos
 */
function loadIframeVentanaModal(idVentanaModal, idIframe, urlDestino) {

    $('#' + idVentanaModal).on('show.bs.modal', function() {
        loaderIn();
        $('#' + idIframe).attr("src", urlDestino);
    });
    $('#' + idVentanaModal).on('hidden.bs.modal', function() {
        $('#' + idIframe).attr("src", "");
    });
...
function aparienciaBotonFilestyleWCOM(idInput, classBoton, textoBoton, separado) {
    //Apariencia del input
    $('#' + idInput + ' + .bootstrap-filestyle.input-group .form-control').addClass('wcom-form');
    //Apariencia del boton
    $('#' + idInput + ' + .bootstrap-filestyle.input-group .btn-default').addClass('wcom-button').addClass(classBoton);
    if (separado === true) {
        $('#' + idInput + ' + .bootstrap-filestyle.input-group').addClass('button-sep');
    }
    //Texto del boton
    $('#' + idInput + ' + .bootstrap-filestyle.input-group .btn-default .buttonText').addClass('button-text');
    $(":file[id=" + idInput + "]").filestyle('buttonText', textoBoton);
    //Flecha
    $('#' + idInput + ' + .bootstrap-filestyle.input-group .icon-span-filestyle').remove();
    $('<img>').addClass('button-img').attr('src', getSrcFlechaBoton(classBoton)).attr('alt', '')
        .appendTo($('#' + idInput + ' + .bootstrap-filestyle.input-group .btn-default'));
}

function aparienciaBotonFilestyleMAC(idInput, classBoton, textoBoton, separado) {
    //Apariencia del input
    $('#' + idInput + ' + .bootstrap-filestyle.input-group .form-control').addClass('inputs-form');
    //Apariencia del boton
    $('#' + idInput + ' + .bootstrap-filestyle.input-group .btn-default').addClass('wcom-button').addClass('mac-button').addClass(classBoton);
    if (separado === true) {
        $('#' + idInput + ' + .bootstrap-filestyle.input-group').addClass('button-sep');
    }
    //Texto del boton
    ...
    //Flecha
    $('#' + idInput + ' + .bootstrap-filestyle.input-group .icon-span-filestyle').remove();
    $('<img>').addClass('button-img').attr('src', getSrcUploadBoton(classBoton)).attr('alt', '')
        .appendTo($('#' + idInput + ' + .bootstrap-filestyle.input-group .btn-default'));
}

/*
 * Obtiene la ruta completa de la flecha del boton, segun la clase
 */
function getSrcFlechaBoton(classBoton) {
    switch (classBoton) {
        case "button-orange":
            return "/webclipb/img/comunes/arrow_right_white.svg";
        case "button-green":
            return "/webclipb/img/comunes/arrow_right_yellow.svg";
        case "button-trans-dark":
            return "/webclipb/img/comunes/arrow_right_green_dark.svg";
        default:
            return "/webclipb/img/comunes/arrow_right_yellow.svg";
    }
}
...
/*
 * Obtiene la ruta completa de la imagen del upload, segun la clase
 */
function getSrcUploadBoton(classBoton) {
    switch (classBoton) {
        case "button-orange":
            return "/webclipb/img/iconos/ico-modal-upload-white.svg";
        case "button-green":
            return "/webclipb/img/iconos/ico-modal-upload-white.svg"; //return "/webclipb/img/iconos/ico-modal-upload-yellow.svg"; 
        case "button-trans-green":
            return "/webclipb/img/iconos/ico-modal-upload-green.svg";
        default:
            return "/webclipb/img/iconos/ico-modal-upload-green.svg";
    }
}
...
/*
 * Marca errores de validacion en los formularios
 * Si se utiliza algun combo con el bootstrap-select, empieza el proceso despues de generar dicho combo
 */
 ...
 * addErrorInput
 *
 * AÃƒÂƒÃ‚Â¯ÃƒÂ‚Ã‚Â¿ÃƒÂ‚Ã‚Å“ade los errores a los campos asociados
 *
 */
